...
import 'package:zero_hunger_client_app/src/features/farmer/forms/view.answer.form.layout.dart';
...
class _ViewAnswerScreenState extends State<ViewAnswerScreen>
  ...
  void configureWidgetListData() {
    ...
    listViews.add(
        viewAnswerFormLayout(basicQuestionModel: widget.basicQuestionModel));
  }
