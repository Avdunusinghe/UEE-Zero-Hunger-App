...
class SaveQuestionScreen extends StatefulWidget {
  const SaveQuestionScreen({Key? key, this.animationController})
      : super(key: key);
  final AnimationController? animationController;
  @override
  State<SaveQuestionScreen> createState() => _SaveQuestionScreenState();
}

class _SaveQuestionScreenState extends State<SaveQuestionScreen>
  ...
  void configureWidgetListData() {
    ...
    listViews.add(SaveQuestionForm(saveQuestion: this.saveQuestion));
  }
